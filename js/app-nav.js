...
function openHiddenPage(){
  // ✅ FIX — Plus de modal choix profil (connexion obligatoire au lancement)
  // Si pas de profil défini, rediriger vers login
...
// La connexion est obligatoire au lancement, le choix de profil se fait via l'auth v2
