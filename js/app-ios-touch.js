...
(function () {
  ...
  // Format : { id, mode }
  //   mode 'bottom' : le conteneur monte en changeant sa propriété bottom (hiddenPage)
  ...
  //
  // Stratégie par mode :
  //   'bottom' : le conteneur remonte en augmentant bottom (hiddenPage)
  ...
  function _applyKeyboard() {
    ...
    KEYBOARD_TARGETS.forEach(function (cfg) {
      ...
      if (cfg.mode === 'bottom') {
        // hiddenPage : monte via bottom + affiche le bg de remplissage
  ...
  window._dmUpdateVP = _applyKeyboard;
