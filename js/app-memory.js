...
function _memArchiSetup3Cols(){
  ...
  function makeCol(label,labelColor,borderColor,stackId,shapesId){
    ...
    var stack=document.createElement('div');stack.style.cssText='display:flex;flex-direction:column;gap:6px;align-items:center;min-height:52px;width:100%;justify-content:flex-end;';
  ...
  var tgt=document.createElement('div');tgt.id='memArchiTarget';tgt.style.cssText='display:flex;flex-direction:column;gap:6px;align-items:center;min-height:52px;width:100%;justify-content:flex-end;';
