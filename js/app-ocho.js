...
(function () {
  ...
  function _cardInner(card, small) {
    ...
    var subHtml;
    if (val==='+1') subHtml='<span style="font-family:Arial Rounded MT Bold,Arial Black,sans-serif;font-size:'+sub+'px;font-weight:900;color:'+dark+'">Q</span><i class="bi '+icon+'" style="font-size:'+sub+'px;color:'+dark+'"></i>';
    else if (val==='+2') subHtml='<span style="font-family:Arial Rounded MT Bold,Arial Black,sans-serif;font-size:'+sub+'px;font-weight:900;color:'+dark+'">K</span><i class="bi '+icon+'" style="font-size:'+sub+'px;color:'+dark+'"></i>';
    else if (val==='block') subHtml='<span style="font-family:Arial Rounded MT Bold,Arial Black,sans-serif;font-size:'+sub+'px;font-weight:900;color:'+dark+'">J</span><i class="bi '+icon+'" style="font-size:'+sub+'px;color:'+dark+'"></i>';
    else subHtml='<i class="bi '+icon+'" style="font-size:'+(sub+3)+'px;color:'+dark+'"></i>';

    return '<div style="position:absolute;inset:0;background:'+bg+';">'+
      '<i class="bi '+icon+'" style="position:absolute;top:'+(small?-16:-18)+'px;left:'+(small?-18:-14)+'px;font-size:'+symFs+'px;line-height:1;color:#F2E8D4;pointer-events:none;"></i>'+
