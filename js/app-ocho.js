...
'#ochoView.active ~ .bottom-nav{display:none!important;}';
  ...
  function _buildOchoHTML(){
    ...
    '<div id="ochoHeader" style="position:absolute;top:0;left:0;right:0;height:40px;display:flex;align-items:flex-end;justify-content:space-between;padding:0 16px 6px;z-index:100;background:linear-gradient(to bottom, rgba(255,255,255,1) 0%, rgba(220,160,140,0.6) 70%, transparent 100%);">'+
