...
(function startLockBadgePolling(){
  ...
  function checkUnread(){
    // Ne pas vérifier si on est dans la conversation InstaLove (dmChatScreen visible)
  ...
  // Relancer checkUnread quand InstaLove se ferme
  document.addEventListener('hiddenPageClosed', function(){
    checkUnread(); // Vérification immédiate après fermeture
  });
})();
